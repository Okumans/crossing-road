...
public:
  ...
  Shader(const char *vertexShaderPath, const char *fragmentShaderPath,
      ...
      : Shader(fromFile(vertexShaderPath, fragmentShaderPath,
                        geometryShaderPath)) {}
  ...
  static Shader fromFile(const char *vertexShaderPath,
    ...
    if (geometryShaderPath != nullptr) {
      ...
      if (!geometryShaderFile.is_open()) {
        std::cerr << "ERROR::SHADER::FILE_NOT_SUCCESSFULLY_READ: Geometry "
                     "Shader File \""
                  << geometryShaderPath << "\" isn't successfully open!\n";
        return Shader(0);
      }
    ...
    return fromSource(vertexShaderSource.c_str(), fragmentShaderSource.c_str(),
